 ...
 */
$aModule = [
	'id'			=> 'imva.biz/services',
	'title'			=>  [
	    'de'    =>  '<img src="../modules/imva.biz/services/out/img/imva.biz-Logo-16.png" alt="imva.biz-Logo" title="imva.biz" />
    		imva.biz-Kernmodul',
        'en'    =>  '<img src="../modules/imva.biz/services/out/img/imva.biz-Logo-16.png" alt="imva.biz logo" title="imva.biz" />
	...
	'extend'		=> [
        \OxidEsales\Eshop\Core\ViewConfig::class
            => \Imva\OxidServices\Core\ViewConfig::class,
        \OxidEsales\Eshop\Core\Language::class
            => \Imva\OxidServices\Core\Language::class,
        \OxidEsales\Eshop\Application\Model\Article::class
            => \Imva\OxidServices\Model\Product::class,
	],
	'controllers'   => [
        // Admin View Controller
        'imva_services_admin'       =>	\Imva\OxidServices\Controller\Admin\Main::class,
	],
    'templates' => [
        'imva_services_admin.tpl'   =>	'imva.biz/services/View/admin/tpl/imva_services_admin.tpl',
    ],
    'blocks'	=>	[
        [
